...
gj.datetimepicker.methods = {
    ...
    initialize: function ($datetimepicker) {
        ...
        // Init datepicker
				data.datepicker.minDate = data.minDate;
				data.datepicker.maxDate = data.maxDate;
    ...
    getMaxDate: function (data) {
		...
		isSelectable: function (data, date) {
        var result = true,
            minDate = gj.datetimepicker.methods.getMinDate(data),
            maxDate = gj.datetimepicker.methods.getMaxDate(data),
            i;
